...
const WhatWeDo = () => {
  return (
    <section className="  md:py-[2%] px-[10%]">
      <div className="flex flex-col justify-center w-full items-center my-6">
        <h3 className=" font-bold text-lg md:text-2xl lg:text-3xl">What We Do</h3>
      ...
      <div className="flex flex-col md:grid md:grid-cols-2 lg:grid-cols-3">
        <div className="bg-[#A6E2E2] p-8 py-10 space-y-2">
          <h3 className="font-bold text-md md:text-xl">Bulipe Tech is a dynamic and innovative company</h3>
